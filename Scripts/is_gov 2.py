...
def fetch_papers(target_count=80):
    ...
    queries = [
        "e-governance public systems information systems",
        "digital government information systems",
        "public sector information systems",
        "government adoption information systems",
        "citizen services information systems",
