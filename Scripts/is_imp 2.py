...
def fetch_papers(target_count=80):
    ...
    queries = [
        "technology adoption information systems",
        "technology acceptance information systems",
        "innovation diffusion information systems",
        "user adoption information systems",
        "digital transformation impact information systems",
        "socio-technical impact information systems",
        "IS impact organizational performance",
        "digital resistance information systems"
    ]
